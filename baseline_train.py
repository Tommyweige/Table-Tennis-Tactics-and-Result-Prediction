...
TUNED_MODEL_PARAMS: dict[tuple[str, str], dict[str, Any]] = {
    ("xgboost", "action"): {
        "n_estimators": 400,
        "learning_rate": 0.019113105660552715,
        "max_depth": 12,
        "min_child_weight": 0.7339412122877271,
        "subsample": 0.9011846402147433,
        "colsample_bytree": 0.6537135219185505,
        "gamma": 0.5187593608987167,
        "reg_alpha": 0.022496257582499322,
        "reg_lambda": 0.9070059443299001,
    },
    ("xgboost", "point"): {
        "n_estimators": 750,
        "learning_rate": 0.012387183765154311,
        "max_depth": 11,
        "min_child_weight": 1.0102149118052446,
        "subsample": 0.847795247325235,
        "colsample_bytree": 0.7949046953077212,
        "gamma": 0.7184963520698437,
        "reg_alpha": 0.0001221214683643462,
        "reg_lambda": 0.5186646074670304,
    },
    ("catboost", "server"): {
        "iterations": 500,
